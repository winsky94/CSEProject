...
public class PlayerTableModel extends MyTableModel{
	...
	static String[] head;
	String[] headbase={"球员名称","所属球队","位置","参赛场数","先发场数","在场时间","篮板数","助攻数","盖帽数","抢断数","犯规数","失误数",
			"效率","得分","投篮命中率","三分命中率","罚球命中率","两双","得分/篮板/助攻"};
	String[] headhigh={"球员名称","所属球队","真实命中率","GmSc效率值","投篮效率","篮板率",
			"进攻数","防守数","进攻篮板率","防守篮板率","助攻率","抢断率","盖帽率","失误率","使用率",};

...
public	class NewSequenceOfPlayer implements Comparator<PlayerVO> {
	
    String sortBy;
    String order;
    ArrayList<String> allSortBy;
    ArrayList<String> allOrder;
	
	
	public NewSequenceOfPlayer(ArrayList<String> allSortBy,ArrayList<String> allOrder){
		super();
		this.allSortBy=allSortBy;
	...
	public int compare(PlayerVO o1, PlayerVO o2) {
		...
		for(int i=0;i<allSortBy.size();i++){
			result=compare(o1, o2, allSortBy.get(i), allOrder.get(i));
			if(result!=0){
				break;
			}
		}
    ...
    private int compare(PlayerVO a1, PlayerVO a2,String theColumn,String theOrder) { 
    	int result=0;
    	sortBy=theColumn;
    	order=theOrder;

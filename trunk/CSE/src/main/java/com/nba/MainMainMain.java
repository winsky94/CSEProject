...
public class MainMainMain {
	public static void main(String[] args) {
		...
		command="-player -high -sort faultEfficient.asc";
		System.out.println(command);
		main.main(command.split(" "));
		
		command="-player -high -sort frequency.ascc";
		System.out.println(command);
		main.main(command.split(" "));
		
		command="-player -hot score";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-player -hot rebound";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-player -hot assist";
		System.out.println(command);
		main.main(command.split(" ")); 
		...
		command="-player -king score -daily";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-player -king rebound -daily";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-player -king rebound -season";
		System.out.println(command);
		main.main(command.split(" ")); 
		...
		command="-player -king assist -season";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-player -avg -all -sort score.desc -filter position.F";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-player -avg -all -sort score.desc -filter position.F,league.East";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-player -avg -all -n 10";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-team -sort score.asc";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-team -avg -all -sort rebound.asc";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-team -sort assist.desc";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-team -sort blockShot.desc";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-team -total -sort steal.desc";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-team -total -all -sort foul.desc";
		System.out.println(command);
		main.main(command.split(" ")); 
		
		command="-team -total -sort fault.asc";
		System.out.println(command);
		main.main(command.split(" ")); 
